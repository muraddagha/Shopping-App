        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sliders_Departments_DepartmentId1",
                        column: x => x.DepartmentId1,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Info = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SettingsId1 = table.Column<long>(type: "bigint", nullable: true),
                    CreateDate = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UpdateDate = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Settings_SettingsId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSliders_Settings_SettingsId1",
                        column: x => x.SettingsId1,
                        principalTable: "Settings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SocialLinks_Settings_SettingsId1",
                        column: x => x.SettingsId1,
                        principalTable: "Settings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId1 = table.Column<long>(type: "bigint", nullable: true),
                    ProductSliderId1 = table.Column<long>(type: "bigint", nullable: true),
                    CreateDate = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UpdateDate = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSliderItems_Products_ProductId1",
                        column: x => x.ProductId1,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductSliderItems_ProductSliders_ProductSliderId1",
                        column: x => x.ProductSliderId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProductOptionId1 = table.Column<long>(type: "bigint", nullable: true),
                    CreateDate = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UpdateDate = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOptionItems_ProductOptions_ProductOptionId1",
                        column: x => x.ProductOptionId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_SettingsId1",
                table: "Contacts",
                column: "SettingsId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOptionItems_ProductOptionId1",
                table: "ProductOptionItems",
                column: "ProductOptionId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSliderItems_ProductId1",
                table: "ProductSliderItems",
                column: "ProductId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSliderItems_ProductSliderId1",
                table: "ProductSliderItems",
                column: "ProductSliderId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSliders_SettingsId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sliders_DepartmentId1",
                table: "Sliders",
                column: "DepartmentId1");

            migrationBuilder.CreateIndex(
                name: "IX_SocialLinks_SettingsId1",
                table: "SocialLinks",
                column: "SettingsId1");
        }
